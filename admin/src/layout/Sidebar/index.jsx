							...
							{items.links.map((link) => {
								...
								return (
									<li key={link.path}>
										<Link
											to={link.path}
											className={`w-full px-5 md:px-3 py-4 2xl:text-base text-[0.9rem] hover:bg-indigo-500/10 flex items-center gap-1 relative before:absolute before:top-0 before:right-0 before:w-1 before:h-full before:bg-indigo-600 before:rounded-full before:scale-0 hover:before:scale-100 before:transition-all before:duration-500 ${
												theme === "dark"
													? "hover:text-white"
